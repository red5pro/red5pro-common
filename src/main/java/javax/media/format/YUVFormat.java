...
public class YUVFormat extends VideoFormat {
    ...
    private static final long serialVersionUID = 3938285670531376124L;
    ...
    @Override
    public Object clone() {
        YUVFormat f = new YUVFormat(size, maxDataLength, dataType, frameRate, yuvType, strideY, strideUV, offsetY, offsetU, offsetV);
        f.copy(this);
        return f;
    }
    ...
    public boolean equals(Object format) {
        if (format instanceof YUVFormat) {
            ...
            return super.equals(format) && yuvType == other.yuvType && strideY == other.strideY && strideUV == other.strideUV && offsetY == other.offsetY && offsetU == other.offsetU && offsetV == other.offsetV;
        } else
            return false;
    }
    ...
    public boolean matches(Format format) {
        ...
        return (yuvType == NOT_SPECIFIED || other.yuvType == NOT_SPECIFIED || yuvType == other.yuvType) &&
                ...
                (strideY == NOT_SPECIFIED || other.strideY == NOT_SPECIFIED || strideY == other.strideY) && (strideUV == NOT_SPECIFIED || other.strideUV == NOT_SPECIFIED || strideUV == other.strideUV) &&

                (offsetY == NOT_SPECIFIED || other.offsetY == NOT_SPECIFIED || offsetY == other.offsetY) && (offsetU == NOT_SPECIFIED || other.offsetU == NOT_SPECIFIED || offsetU == other.offsetU) && (offsetV == NOT_SPECIFIED || other.offsetV == NOT_SPECIFIED || offsetV == other.offsetV);
    ...
    public String toString() {
        return "YUV Video Format: Size = " + size + " MaxDataLength = " + maxDataLength + " DataType = " + dataType + " yuvType = " + yuvType + " StrideY = " + strideY + " StrideUV = " + strideUV + " OffsetY = " + offsetY + " OffsetU = " + offsetU + " OffsetV = " + offsetV + "\n";
    }
}
