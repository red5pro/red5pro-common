...
public class ParameterizedVideoFormat extends VideoFormat {
    ...
    /**
     * Initializes a new <tt>ParameterizedVideoFormat</tt> with a specific encoding  and a specific set of format parameters.
     *
     ...
     *
     * @param encoding the encoding of the new instance
     * @param fmtps the format parameters of the new instance in the form of an array of <tt>String</tt>s in which the key and the value of an
    ...
    /**
     * Determines whether a specific <tt>Object</tt> represents a value that is equal to the value represented by this instance.
     *
     * @param obj the <tt>Object</tt> to be determined whether it represents a value that is equal to the value represented by this instance
     * @return <tt>true</tt> if the specified <tt>obj</tt> represents a value that is equal to the value represented by this instance; otherwise,
     * <tt>false</tt>
     */
    @Override
    ...
    /**
     * Finds the attributes shared by two matching <tt>Format</tt>s. If the specified <tt>Format</tt> does not match this one, the result is
     * undefined.
     *
     * @param format the matching <tt>Format</tt> to intersect with this one
     * @return a <tt>Format</tt> with its attributes set to the attributes common to this instance and the specified format
     */
    @Override
    ...
    /**
     * Determines whether a specific format matches this instance i.e. whether their attributes match according to the definition of "match" given by
    ...
    /**
     * Initializes a new <tt>Map</tt> from an array in which the key and the value of an association are expressed as consecutive elements.
     *
     * @param <T> the very type of the keys and the values to be associated in the new <tt>Map</tt>
     * @param entries the associations to be created in the new <tt>Map</tt> where the key and value of an association are expressed as consecutive
     * elements
