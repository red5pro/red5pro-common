...
public abstract class InterstitialSession implements Comparable<InterstitialSession> {
    ...
    /**
     * Include the metada of the insert.
     * Default is false. Metadata from inserted source material will be dropped.
     */
    ...
    /**
     * When presented with a timestamp, we dispatch alternate content into the prostream.
     * This may be one or none packets depending on the timestamp.
     * @param timestamp value to compare.
     * @param output dispatchInterstitial method
     * @throws IOException
     */
     ...
     * @param isOriginal is this from the original stream (or else, from the interstitial stream)?
     */
    public void dispatchEvent(IEvent event, boolean isOriginal, IInterstitialStream stream) {
        ...
        // log.info("isNeither: {}, isReallyAudio: {}, isReallyVideo: {}", isNeither, isReallyAudio, isReallyVideo);
