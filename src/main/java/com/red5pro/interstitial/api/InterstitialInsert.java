...
public class InterstitialInsert {
	...
	public String toString() {
		return "InterstitialRequest [id=" + id + ", target=" + target + ", interstitial=" + interstitial + ", type="
				+ type + ", loop=" + loop + ", start=" + start + ", duration=" + duration + ", isForwardAudio="
				+ isInterstitialAudio + ", isForwardVideo=" + isInterstitialVideo + "]";
	}
}
