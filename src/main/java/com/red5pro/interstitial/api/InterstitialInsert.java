...
public class InterstitialInsert {
	...
	public String toString() {
		return "InterstitialRequest [id=" + id + ", target=" + target + ", uri=" + uri + ", type=" + type + ", loop="
				+ loop + ", start=" + start + ", duration=" + duration + ", isForwardAudio=" + isInterstitialAudio
				+ ", isForwardVideo=" + isInterstitialVideo + "]";
	}
}
