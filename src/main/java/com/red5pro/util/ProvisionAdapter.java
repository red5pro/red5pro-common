...
/**
 * Provides serialize and deserialization for Provision model objects.
 * 
...
public class ProvisionAdapter implements JsonSerializer<Provision>, JsonDeserializer<Provision> {
    ...
    @Override
    public Provision deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
