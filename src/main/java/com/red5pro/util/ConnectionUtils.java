...
public class ConnectionUtils {
    ...
    /**
     * Returns human readable string for a given instance implementing IConnection type.
     *  
     * @param connection instance of IConnection
    ...
    public static void main(String[] args) {
        // NPE expected, and working as it should
        //System.out.println("Null? " + ConnectionUtils.isRTMP(null) + " return type: " + ConnectionUtils.getConnectionType(null));
        RTMPMinaConnection rtmp = new RTMPMinaConnection();
        System.out.println("RTMP? " + ConnectionUtils.isRTMP(rtmp) + " return type: " + ConnectionUtils.getConnectionType(rtmp));
    }
    */
}
