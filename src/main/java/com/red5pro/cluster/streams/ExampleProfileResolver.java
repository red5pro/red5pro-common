...
/**
 * This example class parses the variant index. It anticipates name_1, name_2, or name. 
 * Lower non-zero indexes are higher quality. 
 * Zero specifies one single quality available. An FMLE type GUI would use '_%i' added to the stream name. 
 * Wirecast would enter specific names with '_1', '_2' added where '_1' is number one quality.
 * When providing quality variant names, Red5Pro requires lower indexes to be higher quality.   
 * @author Andy Shaules
 *
 */
