...
public class VideoConstants {
    ...
    /**
     * The <tt>/rtp</tt> constant. Introduced in order to achieve consistency in the casing of the String.
     */
    ...
    /**
     * The name of the format parameter which specifies the packetization mode f H.264 RTP payload.
     */
     ...
     * @return true if the two sets of format parameters match in the context of the encoding; otherwise, false
     */
    public static boolean formatParametersMatch(String encoding, Map<String, String> fmtps1, Map<String, String> fmtps2) {
        ...
        // RFC 3984 "RTP Payload Format for H.264 Video" says that "[w]hen the value of packetization-mode is equal to 0 or packetization-mode is
    ...
    /**
     * Determines whether a specific set of format parameters is equal to another set of format parameters in the sense that they define an equal
     * number of parameters and assign them equal values. Since the values are <tt>String</tt>s, presumes that a value of <tt>null</tt> is equal to the
     * empty <tt>String</tt>.
     * <p>
     * The two <tt>Map</tt> instances of format parameters to be checked for equality are presumed to be modifiable in the sense that if the lack of a
     * format parameter in a given <tt>Map</tt> is equivalent to it having a specific value, an association of the format parameter to the value in
     * question may be added to or removed from the respective <tt>Map</tt> instance for the purposes of determining equality.
     * </p>
     *
    ...
    public static boolean formatParametersAreEqual(String encoding, Map<String, String> fmtps1, Map<String, String> fmtps2) {
        /*
         * RFC 3984 "RTP Payload Format for H.264 Video" says that "[w]hen the value of packetization-mode is equal to 0 or packetization-mode is
         * not present, the single NAL mode, as defined in section 6.2, MUST be used."
         */
        if (H264.equalsIgnoreCase(encoding) || H264_RTP.equalsIgnoreCase(encoding)) {
