...
/**
 * Decoder for handling an SDP one line at a time. Call doFinal() when all the
 * lines have be added.
 * 
				...
				case 'a' :
					...
					if (attr != null) {
						...
						if (mediaField == null) {
							...
							SDPTrack track = SDPMediaType.audio.equals(mtype)
									? sdp.getAudioTrack()
									: (SDPMediaType.video.equals(mtype)
											? sdp.getVideoTrack()
											: sdp.getApplicationTrack());
